...
Accuracy      -84
"""
data = pd.read_csv('C:\\Users\\rutuj\\OneDrive\\Documents\GitHub\\FinalYearProject\\EyesMLeftNoMoveP5\\EyesMLeftNoMoveP5.csv')
data1 = data.dropna()
...
joblib.dump(model,'EyesMLeftNoMove.pkl')

...
Accuracy      -76
"""
data = pd.read_csv('C:\\Users\\rutuj\\OneDrive\\Documents\GitHub\\FinalYearProject\\EyesMRightNoMoveP5\\EyesMRightNoMoveP5.csv')
data1 = data.dropna()
...
joblib.dump(model,'EyesMRightNoMoveP5.pkl')

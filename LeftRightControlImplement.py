...
#Intializing a Model
loaded_m = joblib.load('LeftRightStraightData.pkl')
...
"""
direction_state = 0 (Right)
direction_state = 1 (Left)
direction_state = 2 (Straight)
"""
    ...
    try:
        ...
        if serialInst.in_waiting > 20:
            ...
            if counter > time_buffer:
                ...
                """
                direction_state -> 2 (Straight)
                direction_state -> 1 (Left View)
                direction_state -> 0 (Right View)
                """
                ...
                if int(eyePrediction) == 2:
                    direction_state = 2
                    left = 0
                    right = 0

                elif int(eyePrediction) == 1:
                    left += 1
                    if left > 4:
                        direction_state = 1
                ...
                if direction_state == 2:
                    print(f"\n\nEyes Direction -> Straight SSSSSSSSSSSSSSSSS")
                elif direction_state == 1:
                    print(f"\n\nEyes Direction -> Left LLLLLLLLLLLLLLLLLLL")
                else:
                    print(f"\n\nEyes Direction -> Right RRRRRRRRRRRRRRRRRRR")

...
Accuracy- 79
"""
data = pd.read_csv('C:\\Users\\rutuj\\OneDrive\\Documents\\GitHub\\FinalYearProject\\LeftVStraight with Previous values\\LeftVStraightP5.csv')
data1 = data.dropna()
...
joblib.dump(model,'LeftVStraightP5.pkl')

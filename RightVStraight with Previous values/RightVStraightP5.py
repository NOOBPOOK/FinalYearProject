...
Accuracy- 79
"""
data = pd.read_csv('C:\\Users\\rutuj\\OneDrive\\Documents\\GitHub\\FinalYearProject\\RightVStraight with Previous values\\RightVStraightP5.csv')
data1 = data.dropna()
...
joblib.dump(model,'RightVStraightP5.pkl')

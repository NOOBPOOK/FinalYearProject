...
Accuracy      -74
"""
data = pd.read_csv('C:\\Users\\rutuj\\OneDrive\\Documents\GitHub\\FinalYearProject\\EyesMLeftRightNoMoveP5\\EyesMLeftRightNoMoveP5.csv')
data1 = data.dropna()
...
joblib.dump(model,'EyesMLeftRightNoMoveP5.pkl')

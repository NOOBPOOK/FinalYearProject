...
Accuracy- 95
"""
data = pd.read_csv('C:\\Users\\rutuj\\OneDrive\\Documents\\GitHub\\FinalYearProject\\LeftCRightCStraight with Previous values\\LeftCRightCStraightP5.csv')
data1 = data.dropna()
...
joblib.dump(model,'LeftCRightCStraightP5.pkl')

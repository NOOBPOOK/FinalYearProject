...
Accuracy- 67
"""
data = pd.read_csv('C:\\Users\\rutuj\\OneDrive\\Documents\\GitHub\\FinalYearProject\\LeftVRightVStraight with Previous values\\LeftRightStraightP5.csv')
data1 = data.dropna()
...
joblib.dump(model,'LeftRightStraightP5.pkl')

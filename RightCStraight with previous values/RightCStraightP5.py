...
Accuracy- 99
"""
data = pd.read_csv('C:\\Users\\rutuj\\OneDrive\\Documents\\GitHub\\FinalYearProject\\RightCStraight with Previous values\\RightCStraightP5.csv')
data1 = data.dropna()
...
joblib.dump(model,'RightCStraightP5.pkl')
